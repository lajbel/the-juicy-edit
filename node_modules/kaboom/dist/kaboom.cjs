...
`,Vs=new Set(["id","require"]),_s=new Set(["add","load","update","draw","destroy","inspect"]);function Sr(i){return i==="pressed"||i==="rpressed"?"down":i==="released"?"up":i}a(Sr,"processButtonState");function Ns(i){i.requestFullscreen?i.requestFullscreen():i.webkitRequestFullscreen&&i.webkitRequestFullscreen()}a(Ns,"enterFullscreen");function ks(){document.exitFullscreen?document.exitFullscreen():document.webkitExitFullScreen&&document.webkitExitFullScreen()}a(ks,"exitFullscreen");function Gs(){return document.fullscreenElement||document.webkitFullscreenElement}a(Gs,"getFullscreenElement");function Ye(i){switch(i){case"topleft":return f(-1,-1);case"top":return f(0,-1);case"topright":return f(1,-1);case"left":return f(-1,0);case"center":return f(0,0);case"right":return f(1,0);case"botleft":return f(-1,1);case"bot":return f(0,1);case"botright":return f(1,1);default:return i}}a(Ye,"originPt");function js(i){switch(i){case"left":return 0;case"center":return .5;case"right":return 1;default:return 0}}a(js,"alignPt");function $t(){return new AudioBuffer({length:1,numberOfChannels:1,sampleRate:44100})}a($t,"createEmptyAudioBuffer");var Xs=a((i={})=>{let n=[],u=(()=>{let e=i.root??document.body;e===document.body&&(document.body.style.width="100%",document.body.style.height="100%",document.body.style.margin="0px",document.documentElement.style.width="100%",document.documentElement.style.height="100%");let t=i.canvas??(()=>{let h=document.createElement("canvas");return e.appendChild(h),h})(),r=i.scale??1;i.width&&i.height&&!i.stretch&&!i.letterbox?(t.width=i.width*r,t.height=i.height*r):(t.width=t.parentElement.offsetWidth,t.height=t.parentElement.offsetHeight);let o=t.width,d=t.height,s=i.pixelDensity||window.devicePixelRatio;t.width*=s,t.height*=s;let l=[`width: ${o}px`,`height: ${d}px`,"outline: none","cursor: default"];return i.crisp&&(l.push("image-rendering: pixelated"),l.push("image-rendering: crisp-edges")),t.style=l.join(";"),t.setAttribute("tabindex","0"),{canvas:t,canvas2:t.cloneNode(),scale:r,pixelDensity:s,keyStates:{},mouseStates:{},charInputted:[],numKeyDown:0,isMouseMoved:!1,isKeyPressed:!1,isKeyPressedRepeat:!1,isKeyReleased:!1,mouseStarted:!1,mousePos:f(0,0),mouseDeltaPos:f(0,0),time:0,realTime:0,skipTime:!1,dt:0,numFrames:0,isTouch:"ontouchstart"in window||navigator.maxTouchPoints>0,loopID:null,stopped:!1,paused:!1,fpsCounter:new $e}})(),c=u.canvas.getContext("webgl",{antialias:!0,depth:!0,stencil:!0,alpha:!0,preserveDrawingBuffer:!0});class U{glTex;width;height;constructor(t,r,o={}){this.glTex=c.createTexture(),n.push(()=>this.free()),this.bind(),t&&r&&c.texImage2D(c.TEXTURE_2D,0,c.RGBA,t,r,0,c.RGBA,c.UNSIGNED_BYTE,null),this.width=t,this.height=r;let d=(()=>{switch(o.filter??i.texFilter){case"linear":return c.LINEAR;case"nearest":return c.NEAREST;default:return c.NEAREST}})(),s=(()=>{switch(o.wrap){case"repeat":return c.REPEAT;case"clampToEdge":return c.CLAMP_TO_EDGE;default:return c.CLAMP_TO_EDGE}})();c.texParameteri(c.TEXTURE_2D,c.TEXTURE_MIN_FILTER,d),c.texParameteri(c.TEXTURE_2D,c.TEXTURE_MAG_FILTER,d),c.texParameteri(c.TEXTURE_2D,c.TEXTURE_WRAP_S,s),c.texParameteri(c.TEXTURE_2D,c.TEXTURE_WRAP_T,s),this.unbind()}static fromImage(t,r={}){let o=new U(0,0,r);return o.bind(),c.texImage2D(c.TEXTURE_2D,0,c.RGBA,c.RGBA,c.UNSIGNED_BYTE,t),o.width=t.width,o.height=t.height,o.unbind(),o}update(t,r,o){this.bind(),c.texSubImage2D(c.TEXTURE_2D,0,t,r,c.RGBA,c.UNSIGNED_BYTE,o),this.unbind()}bind(){c.bindTexture(c.TEXTURE_2D,this.glTex)}unbind(){c.bindTexture(c.TEXTURE_2D,null)}free(){c.deleteTexture(this.glTex)}}a(U,"Texture");let p=(()=>{let e=wt(jt,Xt),t=U.fromImage(new ImageData(new Uint8ClampedArray([255,255,255,255]),1,1));if(i.background){let s=v.fromArray(i.background);c.clearColor(s.r/255,s.g/255,s.b/255,1)}c.enable(c.BLEND),c.enable(c.SCISSOR_TEST),c.blendFuncSeparate(c.SRC_ALPHA,c.ONE_MINUS_SRC_ALPHA,c.ONE,c.ONE_MINUS_SRC_ALPHA);let r=c.createBuffer();c.bindBuffer(c.ARRAY_BUFFER,r),c.bufferData(c.ARRAY_BUFFER,Er*4,c.DYNAMIC_DRAW),Ar.reduce((s,l,h)=>(c.vertexAttribPointer(h,l.size,c.FLOAT,!1,pt*4,s),c.enableVertexAttribArray(h),s+l.size*4),0),c.bindBuffer(c.ARRAY_BUFFER,null);let o=c.createBuffer();c.bindBuffer(c.ELEMENT_ARRAY_BUFFER,o),c.bufferData(c.ELEMENT_ARRAY_BUFFER,Tr*4,c.DYNAMIC_DRAW),c.bindBuffer(c.ELEMENT_ARRAY_BUFFER,null);let d=U.fromImage(new ImageData(new Uint8ClampedArray([128,128,128,255,190,190,190,255,190,190,190,255,128,128,128,255]),2,2),{wrap:"repeat",filter:"nearest"});return{drawCalls:0,lastDrawCalls:0,defShader:e,curShader:e,defTex:t,curTex:t,curUniform:{},vbuf:r,ibuf:o,vqueue:[],iqueue:[],transform:new M,transformStack:[],bgTex:d,width:i.width,height:i.height,viewport:{x:0,y:0,width:c.drawingBufferWidth,height:c.drawingBufferHeight}}})();ln();class S{tex;frames=[new I(0,0,1,1)];anims={};constructor(t,r,o={}){this.tex=t,r&&(this.frames=r),this.anims=o}static from(t,r={}){return typeof t=="string"?S.fromURL(t,r):Promise.resolve(S.fromImage(t,r))}static fromImage(t,r={}){return new S(U.fromImage(t,r),xe(r.sliceX||1,r.sliceY||1),r.anims??{})}static fromURL(t,r={}){return ye(t).then(o=>S.fromImage(o,r))}}a(S,"SpriteData");class D{buf;constructor(t){this.buf=t}static fromArrayBuffer(t){return new Promise((r,o)=>R.ctx.decodeAudioData(t,r,o)).then(r=>new D(r))}static fromURL(t){return Gt(t)?D.fromArrayBuffer(ir(t)):ze(t).then(r=>D.fromArrayBuffer(r))}}a(D,"SoundData");let R=(()=>{let e=new(window.AudioContext||window.webkitAudioContext),t=e.createGain();t.connect(e.destination);let r=new D($t());return e.decodeAudioData(hr.buffer.slice(0),o=>{r.buf=o},()=>{throw new Error("Failed to load burp.")}),{ctx:e,masterNode:t,burpSnd:r}})();class P{done=!1;data=null;error=null;onLoadEvents=new Z;onErrorEvents=new Z;onFinishEvents=new Z;constructor(t){t.then(r=>{this.data=r,this.onLoadEvents.trigger(r)}).catch(r=>{if(this.error=r,this.onErrorEvents.numListeners()>0)this.onErrorEvents.trigger(r);else throw r}).finally(()=>{this.onFinishEvents.trigger(),this.done=!0})}static loaded(t){let r=new P(Promise.resolve(t));return r.data=t,r.done=!0,r}onLoad(t){return this.onLoadEvents.add(t),this}onError(t){return this.onErrorEvents.add(t),this}onFinish(t){return this.onFinishEvents.add(t),this}then(t){return this.onLoad(t)}catch(t){return this.onError(t)}finally(t){return this.onFinish(t)}}a(P,"Asset");class B{assets=new Map;lastUID=0;add(t,r){let o=t??this.lastUID+++"",d=new P(r);return this.assets.set(o,d),d}addLoaded(t,r){let o=t??this.lastUID+++"",d=P.loaded(r);this.assets.set(o,d)}get(t){return this.assets.get(t)}progress(){if(this.assets.size===0)return 1;let t=0;return this.assets.forEach(r=>{r.done&&t++}),t/this.assets.size}}a(B,"AssetBucket");let x={urlPrefix:"",sprites:new B,fonts:new B,bitmapFonts:new B,sounds:new B,shaders:new B,custom:new B,loaded:!1},g={ev:new he,objEvents:new he,root:At([]),timers:new de,gravity:yr,scenes:{},logs:[],cam:{pos:st(),scale:f(1),angle:0,shake:0,transform:new M}};function Me(e){return x.custom.add(null,e)}a(Me,"load");function ee(){let e=[x.sprites,x.sounds,x.shaders,x.fonts,x.bitmapFonts,x.custom];return e.reduce((t,r)=>t+r.progress(),0)/e.length}a(ee,"loadProgress");function Ke(e){return e!==void 0&&(x.urlPrefix=e),x.urlPrefix}a(Ke,"loadRoot");function Ue(e){let t=x.urlPrefix+e;return fetch(t).then(r=>{if(!r.ok)throw new Error(`Failed to fetch ${t}`);return r})}a(Ue,"fetchURL");function be(e){return Ue(e).then(t=>t.json())}a(be,"fetchJSON");function He(e){return Ue(e).then(t=>t.text())}a(He,"fetchText");function ze(e){return Ue(e).then(t=>t.arrayBuffer())}a(ze,"fetchArrayBuffer");function ye(e){let t=new Image;return t.src=Gt(e)?e:x.urlPrefix+e,t.crossOrigin="anonymous",new Promise((r,o)=>{t.onload=()=>r(t),t.onerror=()=>o(new Error(`Failed to load image from "${e}"`))})}a(ye,"loadImg");function gt(e,t){let r=new FontFace(e,typeof t=="string"?`url(${t})`:t);return document.fonts.add(r),x.fonts.add(e,r.load().catch(()=>{throw new Error(`Failed to load font from "${t}"`)}))}a(gt,"loadFont");function ne(e,t,r,o,d={}){return x.bitmapFonts.add(e,ye(t).then(s=>Ir(U.fromImage(s,d),r,o,d.chars??wr)))}a(ne,"loadBitmapFont");function xe(e=1,t=1,r=0,o=0,d=1,s=1){let l=[],h=d/e,w=s/t;for(let m=0;m<t;m++)for(let b=0;b<e;b++)l.push(new I(r+b*h,o+m*w,h,w));return l}a(xe,"slice");function Yt(e,t){return Me(typeof t=="string"?new Promise((r,o)=>{be(t).then(d=>{Yt(e,d).onLoad(r).onError(o)})}):S.from(e).then(r=>{let o={};for(let d in t){let s=r.tex.width,l=r.tex.height,h=t[d],w=new S(r.tex,xe(h.sliceX,h.sliceY,h.x/s,h.y/l,h.width/s,h.height/l),h.anims);x.sprites.addLoaded(d,w),o[d]=w}return o}))}a(Yt,"loadSpriteAtlas");function ve(e,t,r={sliceX:1,sliceY:1,anims:{}}){return x.sprites.add(e,typeof t=="string"?S.fromURL(t,r):Promise.resolve(S.fromImage(t,r)))}a(ve,"loadSprite");function Dr(e,t){return x.sprites.add(e,new Promise(async r=>{let o=typeof t=="string"?await be(t):t,d=await Promise.all(o.frames.map(ye)),s=document.createElement("canvas");s.width=o.width,s.height=o.height*o.frames.length;let l=s.getContext("2d");d.forEach((w,m)=>{l.drawImage(w,0,m*o.height)});let h=await ve(null,s,{sliceY:o.frames.length,anims:o.anims});r(h)}))}a(Dr,"loadPedit");function Cr(e,t,r){return x.sprites.add(e,new Promise(async o=>{let d=await ve(null,t),s=typeof r=="string"?await be(r):r,l=s.meta.size;d.frames=s.frames.map(h=>new I(h.frame.x/l.w,h.frame.y/l.h,h.frame.w/l.w,h.frame.h/l.h));for(let h of s.meta.frameTags)h.from===h.to?d.anims[h.name]=h.from:d.anims[h.name]={from:h.from,to:h.to,speed:10,loop:!0};o(d)}))}a(Cr,"loadAseprite");function Lr(e,t,r,o=!1){return x.shaders.add(e,new Promise((d,s)=>{let l=a(h=>h?He(h):new Promise(w=>w(null)),"resolveUrl");if(o)Promise.all([l(t),l(r)]).then(([h,w])=>{d(wt(h,w))}).catch(s);else try{d(wt(t,r))}catch(h){s(h)}}))}a(Lr,"loadShader");function Mr(e,t){return x.sounds.add(e,typeof t=="string"?D.fromURL(t):D.fromArrayBuffer(t))}a(Mr,"loadSound");function Wr(e="bean"){return ve(e,dr)}a(Wr,"loadBean");function Kt(e){return x.sprites.get(e)}a(Kt,"getSprite");function Ht(e){return x.sounds.get(e)}a(Ht,"getSound");function qr(e){return x.fonts.get(e)}a(qr,"getFont");function zt(e){return x.bitmapFonts.get(e)}a(zt,"getBitmapFont");function Qt(e){return x.shaders.get(e)}a(Qt,"getShader");function Jt(e){if(typeof e=="string"){let t=Kt(e);if(t)return t;if(ee()<1)return null;throw new Error(`Sprite not found: ${e}`)}else{if(e instanceof S)return P.loaded(e);if(e instanceof P)return e;throw new Error(`Invalid sprite: ${e}`)}}a(Jt,"resolveSprite");function Pr(e){if(typeof e=="string"){let t=Ht(e);if(t)return t.data?t.data:t;if(ee()<1)return null;throw new Error(`Sound not found: ${e}`)}else{if(e instanceof D)return e;if(e instanceof P)return e.data?e.data:e;throw new Error(`Invalid sound: ${e}`)}}a(Pr,"resolveSound");function Fr(e){if(!e)return p.defShader;if(typeof e=="string"){let t=Qt(e);if(t)return t.data?t.data:t;if(ee()<1)return null;throw new Error(`Shader not found: ${e}`)}else if(e instanceof P)return e.data?e.data:e;return e}a(Fr,"resolveShader");function Zt(e){if(!e)return Zt(i.font??Fs);if(typeof e=="string"){let t=zt(e);if(t)return t.data?t.data:t;if(document.fonts.check(`${vr}px ${e}`))return e;if(ee()<1)return null;throw new Error(`Font not found: ${e}`)}else if(e instanceof P)return e.data?e.data:e;return e}a(Zt,"resolveFont");function Or(e){return e!==void 0&&(R.masterNode.gain.value=Y(e,Ur,br)),R.masterNode.gain.value}a(Or,"volume");function We(e,t={loop:!1,volume:1,speed:1,detune:0,seek:0}){let r=Pr(e);if(r instanceof P){let y=We(new D($t())),C=a(W=>{let Q=We(W,t);for(let $ in Q)y[$]=Q[$]},"doPlay");return r.onLoad(C),y}else if(r===null){let y=We(new D($t()));return it(()=>{}),y}let o=R.ctx,d=!1,s=o.createBufferSource();s.buffer=r.buf,s.loop=!!t.loop;let l=o.createGain();s.connect(l),l.connect(R.masterNode);let h=t.seek??0;s.start(0,h);let w=o.currentTime-h,m=null,b={stop(){d||(this.pause(),w=o.currentTime)},play(y){if(!d)return;let C=s;s=o.createBufferSource(),s.buffer=C.buffer,s.loop=C.loop,s.playbackRate.value=C.playbackRate.value,s.detune&&(s.detune.value=C.detune.value),s.connect(l);let W=y??this.time();s.start(0,W),w=o.currentTime-W,d=!1,m=null},pause(){d||(s.stop(),d=!0,m=o.currentTime)},isPaused(){return d},isStopped(){return d},speed(y){return y!==void 0&&(s.playbackRate.value=Y(y,Ms,Ws)),s.playbackRate.value},detune(y){return s.detune?(y!==void 0&&(s.detune.value=Y(y,qs,Ps)),s.detune.value):0},volume(y){return y!==void 0&&(l.gain.value=Y(y,Ur,br)),l.gain.value},loop(){s.loop=!0},unloop(){s.loop=!1},duration(){return r.buf.duration},time(){return d?m-w:o.currentTime-w}};return b.speed(t.speed),b.detune(t.detune),b.volume(t.volume),b}a(We,"play");function en(e){return We(R.burpSnd,e)}a(en,"burp");function wt(e=jt,t=Xt){let r=Is.replace("{{user}}",e??jt),o=Bs.replace("{{user}}",t??Xt),d=c.createShader(c.VERTEX_SHADER),s=c.createShader(c.FRAGMENT_SHADER);c.shaderSource(d,r),c.shaderSource(s,o),c.compileShader(d),c.compileShader(s);let l=c.createProgram();if(n.push(()=>c.deleteProgram(l)),c.attachShader(l,d),c.attachShader(l,s),c.bindAttribLocation(l,0,"a_pos"),c.bindAttribLocation(l,1,"a_uv"),c.bindAttribLocation(l,2,"a_color"),c.linkProgram(l),!c.getProgramParameter(l,c.LINK_STATUS)){let h=a(y=>{let C=/^ERROR:\s0:(?<line>\d+):\s(?<msg>.+)/,W=y.match(C);return{line:Number(W.groups.line),msg:W.groups.msg.replace(/\n\0$/,"")}},"formatShaderError"),w=c.getShaderInfoLog(d),m=c.getShaderInfoLog(s),b="";if(w){let y=h(w);b+=`Vertex shader line ${y.line-14}: ${y.msg}`}if(m){let y=h(m);b+=`Fragment shader line ${y.line-14}: ${y.msg}`}throw new Error(b)}return c.deleteShader(d),c.deleteShader(s),{bind(){c.useProgram(l)},unbind(){c.useProgram(null)},free(){c.deleteProgram(l)},send(h){for(let w in h){let m=h[w],b=c.getUniformLocation(l,w);typeof m=="number"?c.uniform1f(b,m):m instanceof M?c.uniformMatrix4fv(b,!1,new Float32Array(m.m)):m instanceof v?c.uniform4f(b,m.r,m.g,m.b,m.a):m instanceof Ne?c.uniform3f(b,m.x,m.y,m.z):m instanceof q&&c.uniform2f(b,m.x,m.y)}}}}a(wt,"makeShader");function Ir(e,t,r,o){let d=e.width/t,s={},l=o.split("").entries();for(let[h,w]of l)s[w]=new I(h%d*t,Math.floor(h/d)*r,t,r);return{tex:e,map:s,size:r}}a(Ir,"makeFont");function Ut(e,t,r,o=p.defTex,d=p.defShader,s={}){let l=Fr(d);if(!(!l||l instanceof P)){(o!==p.curTex||l!==p.curShader||!_t(p.curUniform,s)||p.vqueue.length+e.length*pt>Er||p.iqueue.length+t.length>Tr)&&ie();for(let h of e){let w=r?p.transform:g.cam.transform.mult(p.transform),m=_r(w.multVec2(h.pos.xy()));p.vqueue.push(m.x,m.y,h.pos.z,h.uv.x,h.uv.y,h.color.r/255,h.color.g/255,h.color.b/255,h.opacity)}for(let h of t)p.iqueue.push(h+p.vqueue.length/pt-e.length);p.curTex=o,p.curShader=l,p.curUniform=s}}a(Ut,"drawRaw");function ie(){!p.curTex||!p.curShader||p.vqueue.length===0||p.iqueue.length===0||(c.bindBuffer(c.ARRAY_BUFFER,p.vbuf),c.bufferSubData(c.ARRAY_BUFFER,0,new Float32Array(p.vqueue)),c.bindBuffer(c.ELEMENT_ARRAY_BUFFER,p.ibuf),c.bufferSubData(c.ELEMENT_ARRAY_BUFFER,0,new Uint16Array(p.iqueue)),p.curShader.bind(),p.curShader.send(p.curUniform),p.curTex.bind(),c.drawElements(c.TRIANGLES,p.iqueue.length,c.UNSIGNED_SHORT,0),p.curTex.unbind(),p.curShader.unbind(),c.bindBuffer(c.ARRAY_BUFFER,null),c.bindBuffer(c.ELEMENT_ARRAY_BUFFER,null),p.vqueue=[],p.iqueue=[],p.drawCalls++)}a(ie,"flush");function Br(){c.clear(c.COLOR_BUFFER_BIT),i.background||se(()=>{Te({width:V(),height:N(),quad:new I(0,0,V()/xr,N()/xr),tex:p.bgTex,fixed:!0})}),p.drawCalls=0,p.transformStack=[],p.transform=new M}a(Br,"frameStart");function Vr(){ie(),p.lastDrawCalls=p.drawCalls}a(Vr,"frameEnd");function _r(e){return f(e.x/V()*2-1,-e.y/N()*2+1)}a(_r,"screen2ndc");function Nr(e){p.transform=e.clone()}a(Nr,"pushMatrix");function O(...e){if(e[0]===void 0)return;let t=f(...e);t.x===0&&t.y===0||(p.transform=p.transform.translate(t))}a(O,"pushTranslate");function Qe(...e){if(e[0]===void 0)return;let t=f(...e);t.x===1&&t.y===1||(p.transform=p.transform.scale(t))}a(Qe,"pushScale");function kr(e){!e||(p.transform=p.transform.rotateX(e))}a(kr,"pushRotateX");function Gr(e){!e||(p.transform=p.transform.rotateY(e))}a(Gr,"pushRotateY");function Ee(e){!e||(p.transform=p.transform.rotateZ(e))}a(Ee,"pushRotateZ");let jr=Ee;function te(){p.transformStack.push(p.transform.clone())}a(te,"pushTransform");function K(){p.transformStack.length>0&&(p.transform=p.transformStack.pop())}a(K,"popTransform");function Te(e){if(e.width===void 0||e.height===void 0)throw new Error('drawUVQuad() requires property "width" and "height".');if(e.width<=0||e.height<=0)return;let t=e.width,r=e.height,d=Ye(e.origin||dt).scale(f(t,r).scale(-.5)),s=e.quad||new I(0,0,1,1),l=e.color||T(255,255,255),h=e.opacity??1;te(),O(e.pos),Ee(e.angle),Qe(e.scale),O(d),Ut([{pos:le(-t/2,r/2,0),uv:f(e.flipX?s.x+s.w:s.x,e.flipY?s.y:s.y+s.h),color:l,opacity:h},{pos:le(-t/2,-r/2,0),uv:f(e.flipX?s.x+s.w:s.x,e.flipY?s.y+s.h:s.y),color:l,opacity:h},{pos:le(t/2,-r/2,0),uv:f(e.flipX?s.x:s.x+s.w,e.flipY?s.y+s.h:s.y),color:l,opacity:h},{pos:le(t/2,r/2,0),uv:f(e.flipX?s.x:s.x+s.w,e.flipY?s.y:s.y+s.h),color:l,opacity:h}],[0,1,3,1,2,3],e.fixed,e.tex,e.shader,e.uniform),K()}a(Te,"drawUVQuad");function Xr(e){if(!e.tex)throw new Error('drawTexture() requires property "tex".');let t=e.quad??new I(0,0,1,1),r=e.tex.width*t.w,o=e.tex.height*t.h,d=f(1);if(e.tiled){let s=Math.ceil((e.width||r)/r),l=Math.ceil((e.height||o)/o),w=Ye(e.origin||dt).add(f(1,1)).scale(.5).scale(s*r,l*o);for(let m=0;m<s;m++)for(let b=0;b<l;b++)Te({...e,pos:(e.pos||f(0)).add(f(r*m,o*b)).sub(w),scale:d.scale(e.scale||f(1)),tex:e.tex,quad:t,width:r,height:o,origin:"topleft"})}else e.width&&e.height?(d.x=e.width/r,d.y=e.height/o):e.width?(d.x=e.width/r,d.y=d.x):e.height&&(d.y=e.height/o,d.x=d.y),Te({...e,scale:d.scale(e.scale||f(1)),tex:e.tex,quad:t,width:r,height:o})}a(Xr,"drawTexture");function tn(e){if(!e.sprite)throw new Error('drawSprite() requires property "sprite"');let t=Jt(e.sprite);if(!t||!t.data)return;let r=t.data.frames[e.frame??0];if(!r)throw new Error(`Frame not found: ${e.frame??0}`);Xr({...e,tex:t.data.tex,quad:r.scale(e.quad||new I(0,0,1,1))})}a(tn,"drawSprite");function qe(e,t,r,o,d,s=1){o=ce(o%360),d=ce(d%360),d<=o&&(d+=Math.PI*2);let l=Math.ceil(Math.max(Math.sqrt(t+r)*3*(s||1),16)),h=(d-o)/l,w=[];for(let m=o;m<d;m+=h)w.push(e.add(t*Math.cos(m),r*Math.sin(m)));return w.push(e.add(t*Math.cos(d),r*Math.sin(d))),w}a(qe,"getArcPts");function j(e){if(e.width===void 0||e.height===void 0)throw new Error('drawRect() requires property "width" and "height".');if(e.width<=0||e.height<=0)return;let t=e.width,r=e.height,d=Ye(e.origin||dt).add(1,1).scale(f(t,r).scale(-.5)),s=[f(0,0),f(t,0),f(t,r),f(0,r)];if(e.radius){let l=Math.min(Math.min(t,r)/2,e.radius);s=[f(l,0),f(t-l,0),...qe(f(t-l,l),l,l,270,360),f(t,l),f(t,r-l),...qe(f(t-l,r-l),l,l,0,90),f(t-l,r),f(l,r),...qe(f(l,r-l),l,l,90,180),f(0,r-l),f(0,l),...qe(f(l,l),l,l,180,270)]}Se({...e,offset:d,pts:s,...e.gradient?{colors:e.horizontal?[e.gradient[0],e.gradient[1],e.gradient[1],e.gradient[0]]:[e.gradient[0],e.gradient[0],e.gradient[1],e.gradient[1]]}:{}})}a(j,"drawRect");function Pe(e){let{p1:t,p2:r}=e;if(!t||!r)throw new Error('drawLine() requires properties "p1" and "p2".');let o=e.width||1,d=r.sub(t).unit().normal().scale(o*.5),s=[t.sub(d),t.add(d),r.add(d),r.sub(d)].map(l=>({pos:le(l.x,l.y,0),uv:f(0),color:e.color??v.WHITE,opacity:e.opacity??1}));Ut(s,[0,1,3,1,2,3],e.fixed,p.defTex,e.shader,e.uniform)}a(Pe,"drawLine");function nn(e){let t=e.pts;if(!t)throw new Error('drawLines() requires property "pts".');if(!(t.length<2))if(e.radius&&t.length>=3){let r=t[0].dist(t[1]);for(let d=1;d<t.length-1;d++)r=Math.min(t[d].dist(t[d+1]),r);let o=Math.min(e.radius,r/2);Pe({...e,p1:t[0],p2:t[1]});for(let d=1;d<t.length-2;d++){let s=t[d],l=t[d+1];Pe({...e,p1:s,p2:l})}Pe({...e,p1:t[t.length-2],p2:t[t.length-1]})}else for(let r=0;r<t.length-1;r++)Pe({...e,p1:t[r],p2:t[r+1]})}a(nn,"drawLines");function rn(e){if(!e.p1||!e.p2||!e.p3)throw new Error('drawPolygon() requires properties "p1", "p2" and "p3".');return Se({...e,pts:[e.p1,e.p2,e.p3]})}a(rn,"drawTriangle");function bt(e){if(!e.radius)throw new Error('drawCircle() requires property "radius".');e.radius!==0&&sn({...e,radiusX:e.radius,radiusY:e.radius,angle:0})}a(bt,"drawCircle");function sn(e){if(e.radiusX===void 0||e.radiusY===void 0)throw new Error('drawEllipse() requires properties "radiusX" and "radiusY".');if(e.radiusX===0||e.radiusY===0)return;let t=e.start??0,r=e.end??360,o=qe(f(0),e.radiusX,e.radiusY,t,r,e.resolution);o.unshift(f(0));let d={...e,pts:o,radius:0,...e.gradient?{colors:[e.gradient[0],...Array(o.length-1).fill(e.gradient[1])]}:{}};if(r-t>=360&&e.outline){e.fill!==!1&&Se({...d,outline:null}),Se({...d,pts:o.slice(1),fill:!1});return}Se(d)}a(sn,"drawEllipse");function Se(e){if(!e.pts)throw new Error('drawPolygon() requires property "pts".');let t=e.pts.length;if(!(t<3)){if(te(),O(e.pos),Qe(e.scale),Ee(e.angle),O(e.offset),e.fill!==!1){let r=e.color??v.WHITE,o=e.pts.map((s,l)=>({pos:le(s.x,s.y,0),uv:f(0,0),color:e.colors?e.colors[l]??r:r,opacity:e.opacity??1})),d=[...Array(t-2).keys()].map(s=>[0,s+1,s+2]).flat();Ut(o,e.indices??d,e.fixed,p.defTex,e.shader,e.uniform)}e.outline&&nn({pts:[...e.pts,e.pts[0]],radius:e.radius,width:e.outline.width,color:e.outline.color,uniform:e.uniform,fixed:e.fixed}),K()}}a(Se,"drawPolygon");function on(e,t,r){ie(),c.clear(c.STENCIL_BUFFER_BIT),c.enable(c.STENCIL_TEST),c.stencilFunc(c.NEVER,1,255),c.stencilOp(c.REPLACE,c.REPLACE,c.REPLACE),t(),ie(),c.stencilFunc(r,1,255),c.stencilOp(c.KEEP,c.KEEP,c.KEEP),e(),ie(),c.disable(c.STENCIL_TEST)}a(on,"drawStenciled");function $r(e,t){on(e,t,c.EQUAL)}a($r,"drawMasked");function Yr(e,t){on(e,t,c.NOTEQUAL)}a(Yr,"drawSubtracted");function se(e){ie();let t=p.width,r=p.height;p.width=p.viewport.width,p.height=p.viewport.height,e(),ie(),p.width=t,p.height=r}a(se,"drawUnscaled");function an(e,t){t.pos&&(e.pos=e.pos.add(t.pos)),t.scale&&(e.scale=e.scale.scale(f(t.scale))),t.angle&&(e.angle+=t.angle),t.color&&(e.color=e.color.mult(t.color)),t.opacity&&(e.opacity*=t.opacity)}a(an,"applyCharTransform");let un=/\[(?<text>[^\]]*)\]\.(?<style>[\w\.]+)+/g;function Kr(e){let t={},r=e.replace(un,"$1"),o=0;for(let d of e.matchAll(un)){let s=d.groups.style.split("."),l=d.index-o;for(let h=l;h<d.index+d.groups.text.length;h++)t[h]={localIdx:h-l,styles:s};o+=3+d.groups.style.length}return{charStyleMap:t,text:r}}a(Kr,"compileStyledText");let yt={};function me(e){if(e.text===void 0)throw new Error('formatText() requires property "text".');let t=Zt(e.font);if(e.text===""||t instanceof P||!t)return{width:0,height:0,chars:[],opt:e};let{charStyleMap:r,text:o}=Kr(e.text+""),d=o.split("");if(t instanceof FontFace||typeof t=="string"){let L=t instanceof FontFace?t.family:t,E=yt[L]??{font:{tex:new U(ft,ft),map:{},size:vr},cursor:f(0)};yt[L]||(yt[L]=E),t=E.font;for(let F of d)if(!E.font.map[F]){let J=u.canvas2.getContext("2d");J.font=`${t.size}px ${L}`,J.clearRect(0,0,u.canvas2.width,u.canvas2.height),J.textBaseline="top",J.textAlign="left",J.fillStyle="rgb(255, 255, 255)",J.fillText(F,0,0);let Be=J.measureText(F),Ce=Math.ceil(Be.width),Le=J.getImageData(0,0,Ce,t.size);if(E.cursor.x+Ce>ft&&(E.cursor.x=0,E.cursor.y+=t.size,E.cursor.y>ft))throw new Error("Font atlas exceeds character limit");t.tex.update(E.cursor.x,E.cursor.y,Le),t.map[F]=new I(E.cursor.x,E.cursor.y,Ce,t.size),E.cursor.x+=Ce}}let s=e.size||t.size,l=f(e.scale??1).scale(s/t.size),h=e.lineSpacing??0,w=e.letterSpacing??0,m=0,b=0,y=0,C=[],W=[],Q=0,$=null,we=null;for(;Q<d.length;){let L=d[Q];if(L===`
`)y+=s+h,C.push({width:m-w,chars:W}),$=null,we=null,m=0,W=[];else{let E=t.map[L],F=E.w*l.x;E&&(e.width&&m+F>e.width&&(y+=s+h,$!=null&&(Q-=W.length-$,L=d[Q],E=t.map[L],F=E.w*l.x,W=W.slice(0,$-1),m=we),$=null,we=null,C.push({width:m-w,chars:W}),m=0,W=[]),W.push({tex:t.tex,width:E.w,height:E.h,quad:new I((E.x+mt)/t.tex.width,(E.y+mt)/t.tex.height,(E.w-mt*2)/t.tex.width,(E.h-mt*2)/t.tex.height),ch:L,pos:f(m,y),opacity:e.opacity??1,color:e.color??v.WHITE,scale:f(l),angle:0}),L===" "&&($=W.length,we=m),m+=F,b=Math.max(b,m),m+=w)}Q++}C.push({width:m-w,chars:W}),y+=s,e.width&&(b=e.width);let De=[];for(let L of C){let E=(b-L.width)*js(e.align??"left");for(let F of L.chars){let J=t.map[F.ch],Be=De.length,Ce=new q(J.w*l.x*.5,J.h*l.y*.5);if(F.pos=F.pos.add(E,0).add(Ce),e.transform){let Le=typeof e.transform=="function"?e.transform(Be,F.ch):e.transform;Le&&an(F,Le)}if(r[Be]){let{styles:Le,localIdx:rs}=r[Be];for(let is of Le){let Lt=e.styles[is],_n=typeof Lt=="function"?Lt(rs,F.ch):Lt;_n&&an(F,_n)}}De.push(F)}}return{width:b,height:y,chars:De,opt:e}}a(me,"formatText");function cn(e){pe(me(e))}a(cn,"drawText");function pe(e){te(),O(e.opt.pos),Ee(e.opt.angle),O(Ye(e.opt.origin??"topleft").add(1,1).scale(e.width,e.height).scale(-.5)),e.chars.forEach(t=>{Te({tex:t.tex,width:t.width,height:t.height,pos:t.pos,scale:t.scale,angle:t.angle,color:t.color,opacity:t.opacity,quad:t.quad,origin:"center",uniform:e.opt.uniform,shader:e.opt.shader,fixed:e.opt.fixed})}),K()}a(pe,"drawFormattedText");function ln(){let e=u.pixelDensity,t=c.drawingBufferWidth/e,r=c.drawingBufferHeight/e;if(wn()){let o=window.innerWidth,d=window.innerHeight,s=o/d,l=t/r;if(s>l){let h=window.innerHeight*l;p.viewport={x:(o-h)/2,y:0,width:h,height:d}}else{let h=window.innerWidth/l;p.viewport={x:0,y:(d-h)/2,width:o,height:h}}return}if(i.letterbox){if(!i.width||!i.height)throw new Error("Letterboxing requires width and height defined.");let o=t/r,d=i.width/i.height;if(o>d){i.stretch||(p.width=r*d,p.height=r);let s=r*d,l=r,h=(t-s)/2;c.scissor(h*e,0,s*e,l*e),c.viewport(h*e,0,s*e,r*e),p.viewport={x:h,y:0,width:s,height:r}}else{i.stretch||(p.width=t,p.height=t/d);let s=t,l=t/d,h=(r-l)/2;c.scissor(0,h*e,s*e,l*e),c.viewport(0,h*e,t*e,l*e),p.viewport={x:0,y:h,width:t,height:l}}return}if(i.stretch){if(!i.width||!i.height)throw new Error("Stretching requires width and height defined.");c.viewport(0,0,t*e,r*e),p.viewport={x:0,y:0,width:t,height:r};return}p.width=t/u.scale,p.height=r/u.scale,c.viewport(0,0,t*e,r*e),p.viewport={x:0,y:0,width:t,height:r}}a(ln,"updateViewport");function V(){return p.width}a(V,"width");function N(){return p.height}a(N,"height");let k={},Fe={},ge={};function Je(e){return f((e.x-p.viewport.x)*V()/p.viewport.width,(e.y-p.viewport.y)*N()/p.viewport.height)}a(Je,"windowToContent");function Hr(e){return f(e.x*p.viewport.width/p.width,e.y*p.viewport.height/p.height)}a(Hr,"contentToView");function xt(e,t){let r=Je(f(e,t));u.mouseStarted&&(u.mouseDeltaPos=r.sub(u.mousePos)),u.mousePos=r,u.mouseStarted=!0,u.isMouseMoved=!0}a(xt,"setMousePos"),k.mousemove=e=>{xt(e.offsetX,e.offsetY)},k.mousedown=e=>{let t=gr[e.button];t&&(u.mouseStates[t]="pressed")},k.mouseup=e=>{let t=gr[e.button];t&&(u.mouseStates[t]="released")},k.keydown=e=>{let t=pr[e.key]||e.key.toLowerCase();Cs.includes(t)&&e.preventDefault(),t.length===1&&u.charInputted.push(e.key),t==="space"&&u.charInputted.push(" "),e.repeat?(u.isKeyPressedRepeat=!0,u.keyStates[t]="rpressed"):(u.isKeyPressed=!0,u.keyStates[t]="pressed"),u.numKeyDown++},k.keyup=e=>{let t=pr[e.key]||e.key.toLowerCase();u.keyStates[t]="released",u.isKeyReleased=!0,u.numKeyDown--},k.touchstart=e=>{e.preventDefault();let t=[...e.changedTouches];t.forEach(r=>{g.ev.trigger("onTouchStart",Je(f(r.clientX,r.clientY)),r)}),i.touchToMouse!==!1&&(xt(t[0].clientX,t[0].clientY),u.mouseStates.left="pressed")},k.touchmove=e=>{e.preventDefault();let t=[...e.changedTouches];t.forEach(r=>{g.ev.trigger("onTouchMove",Je(f(r.clientX,r.clientY)),r)}),i.touchToMouse!==!1&&xt(t[0].clientX,t[0].clientY)},k.touchend=e=>{[...e.changedTouches].forEach(r=>{g.ev.trigger("onTouchEnd",Je(f(r.clientX,r.clientY)),r)}),i.touchToMouse!==!1&&(u.mouseStates.left="released")},k.touchcancel=()=>{i.touchToMouse!==!1&&(u.mouseStates.left="released")},k.contextmenu=function(e){e.preventDefault()},Fe.visibilitychange=()=>{switch(document.visibilityState){case"visible":u.skipTime=!0,A.paused||R.ctx.resume();break;case"hidden":R.ctx.suspend();break}},ge.resize=()=>{},ge.error=e=>Bn(e.error),ge.unhandledrejection=e=>Bn(e.reason);for(let e in k)u.canvas.addEventListener(e,k[e]);for(let e in Fe)document.addEventListener(e,Fe[e]);for(let e in ge)window.addEventListener(e,ge[e]);function H(){return u.mousePos.clone()}a(H,"mousePos");function dn(){return u.mouseDeltaPos.clone()}a(dn,"mouseDeltaPos");function Ze(e="left"){return u.mouseStates[e]==="pressed"}a(Ze,"isMousePressed");function vt(e="left"){return u.mouseStates[e]==="pressed"||u.mouseStates[e]==="down"}a(vt,"isMouseDown");function Et(e="left"){return u.mouseStates[e]==="released"}a(Et,"isMouseReleased");function hn(){return u.isMouseMoved}a(hn,"isMouseMoved");function et(e){return e===void 0?u.isKeyPressed:u.keyStates[e]==="pressed"}a(et,"isKeyPressed");function fn(e){return e===void 0?u.isKeyPressedRepeat:u.keyStates[e]==="pressed"||u.keyStates[e]==="rpressed"}a(fn,"isKeyPressedRepeat");function mn(e){return e===void 0?u.numKeyDown>0:u.keyStates[e]==="pressed"||u.keyStates[e]==="rpressed"||u.keyStates[e]==="down"}a(mn,"isKeyDown");function Tt(e){return e===void 0?u.isKeyReleased:u.keyStates[e]==="released"}a(Tt,"isKeyReleased");function zr(){return[...u.charInputted]}a(zr,"charInputted");function St(){return u.time}a(St,"time");function pn(){return u.canvas.toDataURL()}a(pn,"screenshot");function gn(e){return e&&(u.canvas.style.cursor=e),u.canvas.style.cursor}a(gn,"cursor");function Qr(e=!0){e?Ns(u.canvas):ks()}a(Qr,"fullscreen");function wn(){return Boolean(Gs())}a(wn,"isFullscreen");let A={inspect:!1,timeScale:1,showLog:!0,fps:()=>u.fpsCounter.fps,numFrames:()=>u.numFrames,objCount(){let e=a(t=>t.children.length+t.children.reduce((r,o)=>r+e(o),0),"count");return e(g.root)},stepFrame:On,drawCalls:()=>p.drawCalls,clearLog:()=>g.logs=[],log:e=>g.logs.unshift(`${i.logTime?`[${St().toFixed(2)}].time `:""}[${e?.toString?e.toString():e}].${e instanceof Error?"error":"info"}`),error:e=>A.log(new Error(e.toString?e.toString():e)),curRecording:null,get paused(){return u.paused},set paused(e){u.paused=e,e?R.ctx.suspend():R.ctx.resume()}};function X(){return u.dt*A.timeScale}a(X,"dt");function Jr(...e){return e.length>0&&(g.cam.pos=f(...e)),g.cam.pos.clone()}a(Jr,"camPos");function Zr(...e){return e.length>0&&(g.cam.scale=f(...e)),g.cam.scale.clone()}a(Zr,"camScale");function ei(e){return e!==void 0&&(g.cam.angle=e),g.cam.angle}a(ei,"camRot");function ti(e=12){g.cam.shake=e}a(ti,"shake");function tt(e){return g.cam.transform.multVec2(e)}a(tt,"toScreen");function Un(e){return g.cam.transform.invert().multVec2(e)}a(Un,"toWorld");function At(e){let t=new Map,r={},o=new he,d={_id:or(),hidden:!1,paused:!1,children:[],parent:null,add(s){let l=(()=>{if(Array.isArray(s))return At(s);if(s.parent)throw new Error("Cannot add a game obj that already has a parent.");return s})();return l.parent=this,l.trigger("add",this),it(()=>l.trigger("load")),this.children.push(l),l},readd(s){return this.remove(s),this.children.push(s),s},remove(s){let l=this.children.indexOf(s);l!==-1&&(s.parent=null,s.trigger("destroy"),this.children.splice(l,1))},removeAll(s){this.every(s,l=>this.remove(l))},update(){this.paused||(this.every(s=>s.update()),this.trigger("update"))},draw(){this.hidden||(te(),O(this.pos),Qe(this.scale),Ee(this.angle),this.every(s=>s.draw()),this.trigger("draw"),K())},use(s){if(!s)return;if(typeof s=="string")return this.use({id:s});s.id&&(this.unuse(s.id),t.set(s.id,{}));let l=s.id?t.get(s.id):r;l.cleanups=[];for(let w in s)if(!Vs.has(w)){if(typeof s[w]=="function"){let m=s[w].bind(this);if(_s.has(w)){l.cleanups.push(this.on(w,m)),l[w]=m;continue}else l[w]=m}else l[w]=s[w];this[w]===void 0&&Object.defineProperty(this,w,{get:()=>l[w],set:m=>l[w]=m,configurable:!0,enumerable:!0})}let h=a(()=>{if(!!s.require){for(let w of s.require)if(!this.c(w))throw new Error(`Component '${s.id}' requires component '${w}'`)}},"checkDeps");this.exists()?(s.add&&s.add.call(this),s.load&&it(()=>s.load.call(this)),h()):s.require&&l.cleanups.push(this.on("add",h))},unuse(s){if(t.has(s)){let l=t.get(s);l.cleanups.forEach(h=>h());for(let h in l)delete l[h]}t.delete(s)},c(s){return t.get(s)},get(s){return this.children.filter(l=>s?l.is(s):!0).sort((l,h)=>(l.z??0)-(h.z??0))},every(s,l){if(typeof s=="function"&&l===void 0)return this.get().forEach(h=>s(h));if(typeof s=="string"||Array.isArray(s))return this.get(s).forEach(h=>l(h))},revery(s,l){if(typeof s=="function"&&l===void 0)return this.get().reverse().forEach(h=>s(h));if(typeof s=="string"||Array.isArray(s))return this.get(s).reverse().forEach(h=>l(h))},isAncestorOf(s){return s.parent?s.parent===this||this.isAncestorOf(s.parent):!1},exists(){return g.root.isAncestorOf(this)},is(s){if(s==="*")return!0;if(Array.isArray(s)){for(let l of s)if(!this.c(l))return!1;return!0}else return this.c(s)!=null},on(s,l){return o.on(s,l.bind(this))},trigger(s,...l){o.trigger(s,...l),g.objEvents.trigger(s,this,...l)},destroy(){this.parent?.remove(this)},inspect(){let s={};for(let[l,h]of t)s[l]=h.inspect?h.inspect():null;return s},onUpdate(s){return this.on("update",s)},onDraw(s){return this.on("draw",s)},onDestroy(s){return this.on("destroy",s)},clearEvents(){o.clear()}};for(let s of e)d.use(s);return d}a(At,"make");function Oe(e,t,r){return g.objEvents[e]||(g.objEvents[e]=new de),g.objEvents.on(e,(o,...d)=>{o.is(t)&&r(o,...d)})}a(Oe,"on");function nt(e,t){if(typeof e=="function"&&t===void 0)return g.root.onUpdate(e);if(typeof e=="string")return Oe("update",e,t)}a(nt,"onUpdate");function ni(e,t){if(typeof e=="function"&&t===void 0)return g.root.onDraw(e);if(typeof e=="string")return Oe("draw",e,t)}a(ni,"onDraw");function ri(e,t,r){let o=Oe("collide",e,(l,h,w)=>h.is(t)&&r(l,h,w)),d=Oe("collide",t,(l,h,w)=>h.is(e)&&r(h,l,w)),s=nt(e,l=>{if(!l.area)throw new Error("onCollide() requires the object to have area() component");l._checkCollisions(t,h=>{r(l,h)})});return()=>[o,d,s].forEach(l=>l())}a(ri,"onCollide");function ii(e,t){return typeof e=="function"?En(e):nt(e,r=>{if(!r.area)throw new Error("onClick() requires the object to have area() component");r.isClicked()&&t(r)})}a(ii,"onClick");function si(e,t,r){return nt(e,o=>{if(!o.area)throw new Error("onHover() requires the object to have area() component");o.isHovering()?t(o):r&&r(o)})}a(si,"onHover");function bn(e,t){return new Promise(r=>{g.timers.push(new fe(e,()=>{t&&t(),r()}))})}a(bn,"wait");function oi(e,t){let r=!1,o=a(()=>{r||(t(),bn(e,o))},"newF");return o(),()=>r=!0}a(oi,"loop");function yn(e,t){if(Array.isArray(e)){let r=e.map(o=>yn(o,t));return()=>r.forEach(o=>o())}return g.ev.on("input",()=>mn(e)&&t())}a(yn,"onKeyDown");function z(e,t){if(Array.isArray(e)){let r=e.map(o=>z(o,t));return()=>r.forEach(o=>o())}else return typeof e=="function"?g.ev.on("input",()=>et()&&e()):g.ev.on("input",()=>et(e)&&t())}a(z,"onKeyPress");function xn(e,t){if(Array.isArray(e)){let r=e.map(o=>xn(o,t));return()=>r.forEach(o=>o())}else return typeof e=="function"?g.ev.on("input",()=>et()&&e()):g.ev.on("input",()=>fn(e)&&t())}a(xn,"onKeyPressRepeat");function vn(e,t){if(Array.isArray(e)){let r=e.map(o=>vn(o,t));return()=>r.forEach(o=>o())}else return typeof e=="function"?g.ev.on("input",()=>Tt()&&e()):g.ev.on("input",()=>Tt(e)&&t())}a(vn,"onKeyRelease");function ai(e,t){return typeof e=="function"?g.ev.on("input",()=>vt()&&e(H())):g.ev.on("input",()=>vt(e)&&t(H()))}a(ai,"onMouseDown");function En(e,t){return typeof e=="function"?g.ev.on("input",()=>Ze()&&e(H())):g.ev.on("input",()=>Ze(e)&&t(H()))}a(En,"onMousePress");function ui(e,t){return typeof e=="function"?g.ev.on("input",()=>Et()&&e(H())):g.ev.on("input",()=>Et(e)&&t(H()))}a(ui,"onMouseRelease");function ci(e){return g.ev.on("input",()=>hn()&&e(H(),dn()))}a(ci,"onMouseMove");function li(e){return g.ev.on("input",()=>zr().forEach(t=>e(t)))}a(li,"onCharInput");function di(e){return g.ev.on("onTouchStart",e)}a(di,"onTouchStart");function hi(e){return g.ev.on("onTouchMove",e)}a(hi,"onTouchMove");function fi(e){return g.ev.on("onTouchEnd",e)}a(fi,"onTouchEnd");function Tn(){z("f1",()=>{A.inspect=!A.inspect}),z("f2",()=>{A.clearLog()}),z("f8",()=>{A.paused=!A.paused}),z("f7",()=>{A.timeScale=Ae(Y(A.timeScale-.2,0,2),1)}),z("f9",()=>{A.timeScale=Ae(Y(A.timeScale+.2,0,2),1)}),z("f10",()=>{A.stepFrame()}),z("f5",()=>{g.ev.onOnce("frameEnd",()=>Xe("kaboom.png",pn()))}),z("f6",()=>{A.curRecording?(A.curRecording.download(),A.curRecording=null):A.curRecording=qn()})}a(Tn,"enterDebugMode");function Sn(){z("b",en)}a(Sn,"enterBurpMode");function An(e){return e!==void 0&&(g.gravity=e),g.gravity}a(An,"gravity");function Rn(e,t){return{target:e,displacement:t,isTop:()=>t.y>0,isBottom:()=>t.y<0,isLeft:()=>t.x>0,isRight:()=>t.x<0}}a(Rn,"makeCollision");function Rt(...e){return{id:"pos",pos:f(...e),moveBy(...t){let r=f(...t),o=r.x,d=r.y,s=null;if(this.solid&&this.area?.shape==="rect"){let l=this.worldArea();g.root.every(h=>{if(!this.exists()||h===this||!h.solid||h.area?.shape!=="rect")return;let w=h.worldArea(),m=lt(w,l);if(re(m,f(0))){let L=Math.min(Math.abs(m.p1.x),Math.abs(m.p2.x),Math.abs(m.p1.y),Math.abs(m.p2.y)),E=(()=>{switch(L){case Math.abs(m.p1.x):return f(L,0);case Math.abs(m.p2.x):return f(-L,0);case Math.abs(m.p1.y):return f(0,L);case Math.abs(m.p2.y):return f(0,-L)}})();this.pos=this.pos.sub(E),l=this.worldArea(),m=lt(w,l)}let b={p1:f(0),p2:f(o,d)},y=1,C=m.p1,W=f(m.p1.x,m.p2.y),Q=m.p2,$=f(m.p2.x,m.p1.y),we=0,De={right:{p1:C,p2:W},top:{p1:W,p2:Q},left:{p1:Q,p2:$},bottom:{p1:$,p2:C}};for(let L in De){let E=De[L];if(o===0&&E.p1.x===0&&E.p2.x===0||d===0&&E.p1.y===0&&E.p2.y===0){y=1;break}let F=Ot(b,E);F!=null&&(we++,F<y&&(y=F))}if(y<1&&!(y===0&&we==1&&!re(m,f(o,d)))){let L=f(-o*(1-y),-d*(1-y));o*=y,d*=y,s=Rn(h,L)}})}return this.pos.x+=o,this.pos.y+=d,s&&(this.trigger("collide",s.target,s),s.target.trigger("collide",this,Rn(this,s.displacement.scale(-1)))),s},move(...t){return this.moveBy(f(...t).scale(X()))},moveTo(...t){if(typeof t[0]=="number"&&typeof t[1]=="number")return this.moveTo(f(t[0],t[1]),t[2]);let r=t[0],o=t[1];if(o===void 0){this.pos=f(r);return}let d=r.sub(this.pos);if(d.len()<=o*X()){this.pos=f(r);return}this.move(d.unit().scale(o))},screenPos(){return this.fixed?this.pos:tt(this.pos)},inspect(){return`(${Math.round(this.pos.x)}, ${Math.round(this.pos.y)})`}}}a(Rt,"pos");function rt(...e){return e.length===0?rt(1):{id:"scale",scale:f(...e),scaleTo(...t){this.scale=f(...t)},inspect(){return typeof this.scale=="number"?`${Ae(this.scale,2)}`:`(${Ae(this.scale.x,2)}, ${Ae(this.scale.y,2)})`}}}a(rt,"scale");function mi(e){return{id:"rotate",angle:e??0,inspect(){return`${Math.round(this.angle)}`}}}a(mi,"rotate");function pi(...e){return{id:"color",color:T(...e),inspect(){return this.color.toString()}}}a(pi,"color");function Ae(e,t){return Number(e.toFixed(t))}a(Ae,"toFixed");function gi(e){return{id:"opacity",opacity:e??1,inspect(){return`${Ae(this.opacity,2)}`}}}a(gi,"opacity");function Dt(e){if(!e)throw new Error("Please define an origin");return{id:"origin",origin:e,inspect(){return typeof this.origin=="string"?this.origin:this.origin.toString()}}}a(Dt,"origin");function wi(e){return{id:"z",z:e,inspect(){return`${this.z}`}}}a(wi,"z");function Ui(e,t){return{id:"follow",require:["pos"],follow:{obj:e,offset:t??f(0)},add(){e.exists()&&(this.pos=this.follow.obj.pos.add(this.follow.offset))},update(){e.exists()&&(this.pos=this.follow.obj.pos.add(this.follow.offset))}}}a(Ui,"follow");function bi(e,t){let r=typeof e=="number"?q.fromAngle(e):e.unit();return{id:"move",require:["pos"],update(){this.move(r.scale(t))}}}a(bi,"move");function Dn(e={}){let t=0,r=!1;return{id:"outview",require:["pos","area"],isOutOfView(){let o=f(e.offset??0),d=new Ge(f(0,0).sub(o),f(V(),N()).add(o));return!Bt(this.screenArea(),d)},onExitView(o){return this.on("exitView",o)},onEnterView(o){return this.on("enterView",o)},update(){if(this.isOutOfView()){if(r||(this.trigger("exitView"),r=!0),e.delay&&(t+=X(),t<e.delay))return;e.hide&&(this.hidden=!0),e.pause&&(this.paused=!0),e.destroy&&this.destroy()}else r&&(this.trigger("enterView"),r=!1),t=0,e.hide&&(this.hidden=!1),e.pause&&(this.paused=!1)},inspect(){return this.isOutOfView()}}}a(Dn,"outview");function yi(e={}){return{...Dn({destroy:!0,onExitView:e.onCleanup,offset:e.offset,delay:e.delay}),id:"cleanup"}}a(yi,"cleanup");function xi(e={}){let t={};return{id:"area",add(){this.area.cursor&&this.onHover(()=>gn(this.area.cursor))},area:{shape:"rect",offset:e.offset??f(0),width:e.width,height:e.height,scale:e.scale??f(1),cursor:e.cursor},isClicked(){return Ze()&&this.isHovering()},isHovering(){let r=this.fixed?H():Un(H());return this.hasPoint(r)},isColliding(r){if(!r.area||!r.exists())return!1;let o=this.worldArea(),d=r.worldArea();return rr(o,d)},isTouching(r){if(!r.area||!r.exists())return!1;let o=this.worldArea(),d=r.worldArea();return Hn(o,d)},onClick(r){return this.onUpdate(()=>{this.isClicked()&&r()})},onHover(r,o){return this.onUpdate(()=>{this.isHovering()?r():o&&o()})},onCollide(r,o){let d=this.onUpdate(()=>this._checkCollisions(r,o)),s=this.on("collide",(l,h)=>l.is(r)&&o(l,h));return()=>[d,s].forEach(l=>l())},hasPoint(r){return Vt(this.worldArea(),r)},pushOut(r){if(r===this||r.area?.shape!=="rect")return null;let o=this.worldArea(),d=r.worldArea(),s=lt(o,d);if(!re(s,f(0)))return null;let l=Math.min(Math.abs(s.p1.x),Math.abs(s.p2.x),Math.abs(s.p1.y),Math.abs(s.p2.y)),h=(()=>{switch(l){case Math.abs(s.p1.x):return f(l,0);case Math.abs(s.p2.x):return f(-l,0);case Math.abs(s.p1.y):return f(0,l);case Math.abs(s.p2.y):return f(0,-l)}})();this.pos=this.pos.add(h)},pushOutAll(){g.root.every(this.pushOut)},_checkCollisions(r){g.root.every(r,o=>{this===o||!this.exists()||t[o._id]||this.isColliding(o)&&(this.trigger("collide",o,null),t[o._id]=o)});for(let o in t){let d=t[o];this.isColliding(d)||delete t[o]}},worldArea(){let r=this.area.width??this.width,o=this.area.height??this.height;if(r==null||o==null)throw new Error("Failed to get area dimension");let d=f(this.scale??1).scale(this.area.scale);r*=d.x,o*=d.y;let s=Ye(this.origin||dt),l=(this.pos??f(0)).add(this.area.offset).sub(s.add(1,1).scale(.5).scale(r,o));return{shape:"rect",p1:l,p2:f(l.x+r,l.y+o)}},screenArea(){let r=this.worldArea();return this.fixed?r:{shape:"rect",p1:tt(r.p1),p2:tt(r.p2)}}}}a(xi,"area");function Ie(e){return{color:e.color,opacity:e.opacity,origin:e.origin,outline:e.outline,fixed:e.fixed,shader:e.shader,uniform:e.uniform}}a(Ie,"getRenderProps");function Ct(e,t={}){let r=null,o=null;if(!e)throw new Error("Please pass the resource name or data to sprite()");let d=a((s,l,h,w)=>{let m=f(1,1);return h&&w?(m.x=h/(s.width*l.w),m.y=w/(s.height*l.h)):h?(m.x=h/(s.width*l.w),m.y=m.x):w&&(m.y=w/(s.height*l.h),m.x=m.y),m},"calcTexScale");return{id:"sprite",width:0,height:0,frame:t.frame||0,quad:t.quad||new I(0,0,1,1),animSpeed:t.animSpeed??1,draw(){!r||tn({...Ie(this),sprite:r,frame:this.frame,quad:this.quad,flipX:t.flipX,flipY:t.flipY,tiled:t.tiled,width:t.width,height:t.height})},update(){if(!r){let l=Jt(e);if(!l||!l.data)return;let h=l.data.frames[0].clone();t.quad&&(h=h.scale(t.quad));let w=d(l.data.tex,h,t.width,t.height);this.width=l.data.tex.width*h.w*w.x,this.height=l.data.tex.height*h.h*w.y,t.anim&&this.play(t.anim),r=l.data,this.trigger("spriteLoaded",r)}if(!o)return;let s=r.anims[o.name];if(typeof s=="number"){this.frame=s;return}if(s.speed===0)throw new Error("Sprite anim speed cannot be 0");o.timer+=X()*this.animSpeed,o.timer>=1/o.speed&&(o.timer=0,s.from>s.to?(this.frame--,this.frame<s.to&&(o.loop?this.frame=s.from:(this.frame++,o.onEnd(),this.stop()))):(this.frame++,this.frame>s.to&&(o.loop?this.frame=s.from:(this.frame--,o.onEnd(),this.stop()))))},play(s,l={}){if(!r){this.on("spriteLoaded",()=>{this.play(s,l)});return}let h=r.anims[s];if(!h)throw new Error(`Anim not found: ${s}`);o&&this.stop(),o=typeof h=="number"?{name:s,timer:0,loop:!1,pingpong:!1,speed:0,onEnd:()=>{}}:{name:s,timer:0,loop:l.loop??h.loop??!1,pingpong:l.pingpong??h.pingpong??!1,speed:l.speed??h.speed??10,onEnd:l.onEnd??(()=>{})},this.frame=typeof h=="number"?h:h.from,this.trigger("animStart",s)},stop(){if(!o)return;let s=o.name;o=null,this.trigger("animEnd",s)},numFrames(){return r?r.frames.length:0},curAnim(){return o?.name},flipX(s){t.flipX=s},flipY(s){t.flipY=s},onAnimEnd(s,l){return this.on("animEnd",h=>{h===s&&l()})},onAnimStart(s,l){return this.on("animStart",h=>{h===s&&l()})},inspect(){if(typeof e=="string")return`"${e}"`}}}a(Ct,"sprite");function vi(e,t={}){function r(o){let d=me({...Ie(o),text:o.text+"",size:o.textSize,font:o.font,width:t.width&&o.width,align:o.align,letterSpacing:o.letterSpacing,lineSpacing:o.lineSpacing,transform:o.transform,styles:o.styles});return t.width||(o.width=d.width/(o.scale?.x||1)),o.height=d.height/(o.scale?.y||1),d}return a(r,"update"),{id:"text",text:e,textSize:t.size,font:t.font,width:t.width,height:0,align:t.align,lineSpacing:t.lineSpacing,letterSpacing:t.letterSpacing,transform:t.transform,styles:t.styles,load(){r(this)},draw(){pe(r(this))}}}a(vi,"text");function Ei(e,t,r={}){return{id:"rect",width:e,height:t,radius:r.radius||0,draw(){j({...Ie(this),width:this.width,height:this.height,radius:this.radius})},inspect(){return`${Math.ceil(this.width)}, ${Math.ceil(this.height)}`}}}a(Ei,"rect");function Ti(e,t){return{id:"rect",width:e,height:t,draw(){Te({...Ie(this),width:this.width,height:this.height})},inspect(){return`${Math.ceil(this.width)}, ${Math.ceil(this.height)}`}}}a(Ti,"uvquad");function Si(e){return{id:"circle",radius:e,draw(){bt({...Ie(this),radius:this.radius})},inspect(){return`${Math.ceil(this.radius)}`}}}a(Si,"circle");function Ai(e=1,t=T(0,0,0)){return{id:"outline",outline:{width:e,color:t}}}a(Ai,"outline");function Cn(e,t){let r=new de;return e&&t&&r.pushd(new fe(e,t)),{id:"timer",wait(o,d){return r.pushd(new fe(o,d))},update(){r.forEach((o,d)=>{o.tick(X())&&r.delete(d)})}}}a(Cn,"timer");let Ri=640,Di=65536;function Ci(e={}){let t=0,r=null,o=null,d=!0;return{id:"body",require:["pos","area"],jumpForce:e.jumpForce??Ri,weight:e.weight??1,solid:e.solid??!0,update(){let s=!1;if(r){let l=this.worldArea(),h=r.worldArea(),w=l.p2.y,m=h.p1.y,b=l.p1.x,y=l.p2.x,C=h.p1.x,W=h.p2.x;!r.exists()||w!==m||y<C||b>W?(this.trigger("fall",r),r=null,o=null,s=!0):o&&r.pos&&(this.pos=this.pos.add(r.pos.sub(o)),o=r.pos.clone())}if(!r){let l=this.move(0,t);l&&(l.isBottom()?(r=l.target,t=0,r.pos&&(o=r.pos.clone()),s||(this.trigger("ground",r),d=!0)):l.isTop()&&(t=0,this.trigger("headbutt",l.target))),t+=An()*this.weight*X(),t=Math.min(t,e.maxVel??Di)}},curPlatform(){return r},isGrounded(){return r!==null},isFalling(){return t>0},jump(s){r=null,o=null,t=-s||-this.jumpForce},doubleJump(s){this.isGrounded()?this.jump(s):d&&(d=!1,this.jump(s),this.trigger("doubleJump"))},onGround(s){return this.on("ground",s)},onFall(s){return this.on("fall",s)},onHeadbutt(s){return this.on("headbutt",s)},onDoubleJump(s){return this.on("doubleJump",s)}}}a(Ci,"body");function Li(e,t={}){return{id:"shader",shader:e,uniform:t}}a(Li,"shader");function Mi(){return{id:"solid",require:["area"],solid:!0}}a(Mi,"solid");function Wi(){return{id:"fixed",fixed:!0}}a(Wi,"fixed");function Ln(){return{id:"stay",stay:!0}}a(Ln,"stay");function qi(e){if(e==null)throw new Error("health() requires the initial amount of hp");return{id:"health",hurt(t=1){this.setHP(e-t),this.trigger("hurt")},heal(t=1){this.setHP(e+t),this.trigger("heal")},hp(){return e},setHP(t){e=t,e<=0&&this.trigger("death")},onHurt(t){return this.on("hurt",t)},onHeal(t){return this.on("heal",t)},onDeath(t){return this.on("death",t)},inspect(){return`${e}`}}}a(qi,"health");function Pi(e,t={}){if(e==null)throw new Error("lifespan() requires time");let r=0,o=t.fade??0,d=Math.max(e-o,0);return{id:"lifespan",update(){r+=X(),r>=d&&(this.opacity=ut(r,d,e,1,0)),r>=e&&this.destroy()}}}a(Pi,"lifespan");function Fi(e,t,r){if(!e)throw new Error("state() requires an initial state");let o={};function d(w){o[w]||(o[w]={enter:new Z,leave:new Z,update:new Z,draw:new Z})}a(d,"initStateEvents");function s(w,m,b){return d(m),o[m][w].add(b)}a(s,"on");function l(w,m,...b){d(m),o[m][w].trigger(...b)}a(l,"trigger");let h=!1;return{id:"state",state:e,enterState(w,...m){if(h=!0,t&&!t.includes(w))throw new Error(`State not found: ${w}`);let b=this.state;if(r){if(!r?.[b])return;let y=typeof r[b]=="string"?[r[b]]:r[b];if(!y.includes(w))throw new Error(`Cannot transition state from "${b}" to "${w}". Available transitions: ${y.map(C=>`"${C}"`).join(", ")}`)}l("leave",b,...m),this.state=w,l("enter",w,...m),l("enter",`${b} -> ${w}`,...m)},onStateTransition(w,m,b){return s("enter",`${w} -> ${m}`,b)},onStateEnter(w,m){return s("enter",w,m)},onStateUpdate(w,m){return s("update",w,m)},onStateDraw(w,m){return s("draw",w,m)},onStateLeave(w,m){return s("leave",w,m)},update(){h||(l("enter",e),h=!0),l("update",this.state)},draw(){l("draw",this.state)},inspect(){return this.state}}}a(Fi,"state");function it(e){x.loaded?e():g.ev.on("load",e)}a(it,"onLoad");function Oi(e,t){g.scenes[e]=t}a(Oi,"scene");function Ii(e,...t){if(!g.scenes[e])throw new Error(`Scene not found: ${e}`);g.ev.onOnce("frameEnd",()=>{g.ev=new he,g.objEvents=new he,g.root.every(r=>{r.stay||g.root.remove(r)}),g.root.clearEvents(),g.timers=new de,g.cam={pos:st(),scale:f(1),angle:0,shake:0,transform:new M},g.gravity=yr,g.scenes[e](...t),i.debug!==!1&&Tn(),i.burp&&Sn()})}a(Ii,"go");function Bi(e,t){try{return JSON.parse(window.localStorage[e])}catch{return t?(Mn(e,t),t):null}}a(Bi,"getData");function Mn(e,t){window.localStorage[e]=JSON.stringify(t)}a(Mn,"setData");function Wn(e){let t=e(Re);for(let r in t)Re[r]=t[r],i.global!==!1&&(window[r]=t[r]);return Re}a(Wn,"plug");function st(){return f(V()/2,N()/2)}a(st,"center");function Vi(e,t){return{id:"grid",gridPos:t.clone(),setGridPos(...r){let o=f(...r);this.gridPos=o.clone(),this.pos=f(e.offset().x+this.gridPos.x*e.gridWidth(),e.offset().y+this.gridPos.y*e.gridHeight())},moveLeft(){this.setGridPos(this.gridPos.add(f(-1,0)))},moveRight(){this.setGridPos(this.gridPos.add(f(1,0)))},moveUp(){this.setGridPos(this.gridPos.add(f(0,-1)))},moveDown(){this.setGridPos(this.gridPos.add(f(0,1)))}}}a(Vi,"grid");function _i(e,t){if(!t.width||!t.height)throw new Error("Must provide level grid width & height.");let r=[],o=f(t.pos||f(0)),d=0,s={offset(){return o.clone()},gridWidth(){return t.width},gridHeight(){return t.height},getPos(...l){let h=f(...l);return f(o.x+h.x*t.width,o.y+h.y*t.height)},spawn(l,...h){let w=f(...h),m=(()=>{if(t[l]){if(typeof t[l]!="function")throw new Error("Level symbol def must be a function returning a component list");return t[l](w)}else if(t.any)return t.any(l,w)})();if(!m)return;let b=f(o.x+w.x*t.width,o.y+w.y*t.height);for(let C of m)if(C.id==="pos"){b.x+=C.pos.x,b.y+=C.pos.y;break}m.push(Rt(b)),m.push(Vi(this,w));let y=g.root.add(m);return r.push(y),y},width(){return d*t.width},height(){return e.length*t.height},destroy(){for(let l of r)l.destroy()}};return e.forEach((l,h)=>{let w=l.split("");d=Math.max(w.length,d),w.forEach((m,b)=>{s.spawn(m,f(b,h))})}),s}a(_i,"addLevel");function qn(e){let t=u.canvas.captureStream(e),r=R.ctx.createMediaStreamDestination();R.masterNode.connect(r);let o=new MediaRecorder(t),d=[];return o.ondataavailable=s=>{s.data.size>0&&d.push(s.data)},o.onerror=()=>{R.masterNode.disconnect(r),t.getTracks().forEach(s=>s.stop())},o.start(),{resume(){o.resume()},pause(){o.pause()},stop(){return o.stop(),R.masterNode.disconnect(r),t.getTracks().forEach(s=>s.stop()),new Promise(s=>{o.onstop=()=>{s(new Blob(d,{type:"video/mp4"}))}})},download(s="kaboom.mp4"){this.stop().then(l=>kt(s,l))}}}a(qn,"record");function Ni(){return document.activeElement===u.canvas}a(Ni,"isFocused");let Pn=g.root.add.bind(g.root),ki=g.root.readd.bind(g.root),Gi=g.root.remove.bind(g.root),ji=g.root.removeAll.bind(g.root),Xi=g.root.get.bind(g.root),$i=g.root.every.bind(g.root),Yi=g.root.revery.bind(g.root);function Fn(e=2,t=1){let r=0;return{id:"explode",require:["scale"],update(){let o=Math.sin(r*e)*t;o<0&&this.destroy(),this.scale=f(o),r+=X()}}}a(Fn,"explode");let Ki=ve(null,fr),Hi=ve(null,mr);function zi(e,t={}){let r=Pn([Rt(e),Ln()]),o=(t.speed||1)*5,d=t.scale||1;r.add([Ct(Hi),rt(0),Dt("center"),Fn(o,d),...(t.boomComps??(()=>[]))()]);let s=r.add([Ct(Ki),rt(0),Dt("center"),Cn(.4/o,()=>s.use(Fn(o,d))),...(t.kaComps??(()=>[]))()]);return s.onDestroy(()=>r.destroy()),r}a(zi,"addKaboom");function On(){g.timers.forEach((e,t)=>{e.time-=X(),e.time<=0&&(e.action(),g.timers.delete(t))}),g.root.update()}a(On,"updateFrame");function Qi(){let e=g.cam,t=q.fromAngle(je(0,360)).scale(e.shake);e.shake=_e(e.shake,0,5*X()),e.transform=new M().translate(st()).scale(e.scale).rotateZ(e.angle).translate(e.pos.scale(-1).add(t)),g.root.draw(),ie()}a(Qi,"drawFrame");function Ji(){let e=ee();se(()=>{let t=V()/2,r=24,o=f(V()/2,N()/2).sub(f(t/2,r/2));j({pos:f(0),width:V(),height:N(),color:T(0,0,0)}),j({pos:o,width:t,height:r,fill:!1,outline:{width:4}}),j({pos:o,width:t*e,height:r})}),g.ev.trigger("loading",e)}a(Ji,"drawLoadScreen");function In(e,t){se(()=>{let r=f(8);te(),O(e);let o=me({text:t,font:ht,size:16,pos:r,color:T(255,255,255),fixed:!0}),d=o.width+r.x*2,s=o.height+r.x*2;e.x+d>=V()&&O(f(-d,0)),e.y+s>=N()&&O(f(0,-s)),j({width:d,height:s,color:T(0,0,0),radius:4,opacity:.8,fixed:!0}),pe(o),K()})}a(In,"drawInspectText");function Zi(){if(A.inspect){let e=null,t=v.fromArray(i.inspectColor??[0,0,255]);if(g.root.every(r=>{if(!r.area||r.hidden)return;e||r.isHovering()&&(e=r);let o=e===r?8:4,d=r.worldArea(),s=d.p2.x-d.p1.x,l=d.p2.y-d.p1.y;j({pos:d.p1,width:s,height:l,outline:{width:o,color:t},fill:!1,fixed:r.fixed})}),e){let r=[],o=e.inspect();for(let d in o)o[d]?r.push(`${d}: ${o[d]}`):r.push(`${d}`);In(Hr(H()),r.join(`
`))}In(f(8),`FPS: ${A.fps()}`)}A.paused&&se(()=>{te(),O(V(),0),O(-8,8);let e=32;j({width:e,height:e,origin:"topright",color:T(0,0,0),opacity:.8,radius:4,fixed:!0});for(let t=1;t<=2;t++)j({width:4,height:e*.6,origin:"center",pos:f(-e/3*t,e*.5),color:T(255,255,255),radius:2,fixed:!0});K()}),A.timeScale!==1&&se(()=>{te(),O(V(),N()),O(-8,-8);let e=8,t=me({text:A.timeScale.toFixed(1),font:ht,size:16,color:T(255,255,255),pos:f(-e),origin:"botright",fixed:!0});j({width:t.width+e*2+e*4,height:t.height+e*2,origin:"botright",color:T(0,0,0),opacity:.8,radius:4,fixed:!0});for(let r=0;r<2;r++){let o=A.timeScale<1;rn({p1:f(-t.width-e*(o?2:3.5),-e),p2:f(-t.width-e*(o?2:3.5),-e-t.height),p3:f(-t.width-e*(o?3.5:2),-e-t.height/2),pos:f(-r*e*1+(o?-e*.5:0),0),color:T(255,255,255),fixed:!0})}pe(t),K()}),A.curRecording&&se(()=>{te(),O(0,N()),O(24,-24),bt({radius:12,color:T(255,0,0),opacity:qt(0,1,St()*4),fixed:!0}),K()}),A.showLog&&g.logs.length>0&&se(()=>{te(),O(0,N()),O(8,-8);let e=8,t=i.logMax??Os;g.logs.length>t&&(g.logs=g.logs.slice(0,t));let r=me({text:g.logs.join(`
`),font:ht,pos:f(e,-e),origin:"botleft",size:16,width:V()*.6,lineSpacing:e/2,fixed:!0,styles:{time:{color:T(127,127,127)},info:{color:T(255,255,255)},error:{color:T(255,0,127)}}});j({width:r.width+e*2,height:r.height+e*2,origin:"botleft",color:T(0,0,0),radius:4,opacity:.8,fixed:!0}),pe(r),K()})}a(Zi,"drawDebug"),i.debug!==!1&&Tn(),i.burp&&Sn();function es(e){g.ev.on("loading",e)}a(es,"onLoading");function ts(e){g.ev.on("error",e)}a(ts,"onError");function Bn(e){Vn(()=>{se(()=>{let o=V(),d=N(),s={size:24,width:o-32*2,letterSpacing:4,lineSpacing:4,font:ht};j({width:o,height:d,color:T(0,0,255)});let l=me({...s,text:e.name,pos:f(32),color:T(255,128,0)});pe(l),cn({...s,text:e.message,pos:f(32,32+l.height+16)}),K(),g.ev.trigger("error",e)})})}a(Bn,"handleErr");function Vn(e){u.loopID!==null&&cancelAnimationFrame(u.loopID);let t=a(r=>{if(u.stopped)return;if(document.visibilityState!=="visible"){u.loopID=requestAnimationFrame(t);return}let o=r/1e3,d=o-u.realTime;u.realTime=o,u.skipTime||(u.dt=d,u.time+=X(),u.fpsCounter.tick(u.dt)),u.skipTime=!1,u.numFrames++,Br(),e(),Vr();for(let s in u.keyStates)u.keyStates[s]=Sr(u.keyStates[s]);for(let s in u.mouseStates)u.mouseStates[s]=Sr(u.mouseStates[s]);u.charInputted=[],u.isMouseMoved=!1,u.isKeyPressed=!1,u.isKeyPressedRepeat=!1,u.isKeyReleased=!1,u.loopID=requestAnimationFrame(t),g.ev.trigger("frameEnd")},"frame");t(0)}a(Vn,"run");function ns(){g.ev.onOnce("frameEnd",()=>{u.stopped=!0,c.clear(c.COLOR_BUFFER_BIT|c.DEPTH_BUFFER_BIT|c.STENCIL_BUFFER_BIT);let e=c.getParameter(c.MAX_TEXTURE_IMAGE_UNITS);for(let t=0;t<e;t++)c.activeTexture(c.TEXTURE0+t),c.bindTexture(c.TEXTURE_2D,null),c.bindTexture(c.TEXTURE_CUBE_MAP,null);c.bindBuffer(c.ARRAY_BUFFER,null),c.bindBuffer(c.ELEMENT_ARRAY_BUFFER,null),c.bindRenderbuffer(c.RENDERBUFFER,null),c.bindFramebuffer(c.FRAMEBUFFER,null),n.forEach(t=>t()),c.deleteBuffer(p.vbuf),c.deleteBuffer(p.ibuf);for(let t in k)u.canvas.removeEventListener(t,k[t]);for(let t in Fe)document.removeEventListener(t,Fe[t]);for(let t in ge)window.removeEventListener(t,ge[t])})}a(ns,"quit"),ne("apl386",ar,45,74),ne("apl386o",ur,45,74),ne("sink",cr,6,8,{chars:"\u2588\u263A\u263B\u2665\u2666\u2663\u2660\u25CF\u25CB\u25AA\u25A1\u25A0\u25D8\u266A\u266B\u2261\u25BA\u25C4\u2302\xDE\xC0\xDF\xD7\xA5\u2191\u2193\u2192\u2190\u25CC\u25CF\u25BC\u25B2 !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\u03A7\u2591\u2592\u2593\u1E00\u1E01\u1E02\u2502\u252C\u2524\u250C\u2510\u1E03\u1E04\u253C\u1E05\u1E06\u1E07\u1E08\u1E09\u1E0A\u1E0B\u1E0C\u2500\u251C\u2534\u2514\u2518\u1E0D\u1E0E\u205E\u1E0F\u1E10\u1E11\u1E12\u1E13\u1E14\u1E15\u1E16\u1E17\u1E18\u2584\u1E19\u1E1A\u1E1B\u1E1C\u2026\u1E1D\u1E1E\u1E1F\u1E20\u1E21\u1E22\u1E23\u1E24\u1E25\u1E26\u258C\u2590\u1E27\u1E28\u1E29\u1E2A\u1E2B\u1E2C\u1E2D\u1E2E\u1E2F\u1E30\u1E31\u1E32\u1E33\u1E34\u1E35\u1E36\u1E37\u1E38\u1E39\u1E3A\u1E3B\u1E3C\u1E3D\u1E3E\u1E3F\u1E40\u1E41\u1E42\u1E43\u1E44\u1E45\u1E46\u1E47\u1E48\u1E49\u1E4A\u1E4B\u1E4C\u1E4D\u1E4E\u1E4F\u1E50\u1E51\u1E52\u1E53\u1E54\u1E55\u1E56\u1E57\u1E58\u1E59\u1E5A\u1E5B\u1E5C\u1E5D\u1E5E\u1E5F\u1E60\u1E61\u1E62\u1E63\u1E64\u1E65\u1E66\u1E67\u1E68\u1E69\u1E6A\u1E6B\u1E6C\u1E6D\u1E6E\u1E6F\u1E70\u1E71\u1E72\u1E73\u1E74\u1E75\u1E76\u1E77\u1E78\u1E79\u1E7A\u1E7B\u1E7C"}),ne("sinko",lr,8,10),Vn(()=>{ln();let e=ee();x.loaded||e===1&&(x.loaded=!0,g.ev.trigger("load")),!x.loaded&&i.loadingScreen!==!1?Ji():(g.ev.trigger("input"),A.paused||On(),Qi(),i.debug!==!1&&Zi())});let Re={loadRoot:Ke,loadProgress:ee,loadSprite:ve,loadSpriteAtlas:Yt,loadSound:Mr,loadBitmapFont:ne,loadFont:gt,loadShader:Lr,loadAseprite:Cr,loadPedit:Dr,loadBean:Wr,load:Me,getSprite:Kt,getSound:Ht,getFont:qr,getBitmapFont:zt,getShader:Qt,Asset:P,SpriteData:S,SoundData:D,width:V,height:N,center:st,dt:X,time:St,screenshot:pn,record:qn,isFocused:Ni,cursor:gn,fullscreen:Qr,isFullscreen:wn,onLoad:it,onLoading:es,onError:ts,isTouch:()=>u.isTouch,camPos:Jr,camScale:Zr,camRot:ei,shake:ti,toScreen:tt,toWorld:Un,gravity:An,add:Pn,make:At,destroy:Gi,destroyAll:ji,get:Xi,every:$i,revery:Yi,readd:ki,pos:Rt,scale:rt,rotate:mi,color:pi,opacity:gi,origin:Dt,area:xi,sprite:Ct,text:vi,rect:Ei,circle:Si,uvquad:Ti,outline:Ai,body:Ci,shader:Li,timer:Cn,solid:Mi,fixed:Wi,stay:Ln,health:qi,lifespan:Pi,z:wi,move:bi,outview:Dn,cleanup:yi,follow:Ui,state:Fi,on:Oe,onUpdate:nt,onDraw:ni,onCollide:ri,onClick:ii,onHover:si,onKeyDown:yn,onKeyPress:z,onKeyPressRepeat:xn,onKeyRelease:vn,onMouseDown:ai,onMousePress:En,onMouseRelease:ui,onMouseMove:ci,onCharInput:li,onTouchStart:di,onTouchMove:hi,onTouchEnd:fi,mousePos:H,mouseDeltaPos:dn,isKeyDown:mn,isKeyPressed:et,isKeyPressedRepeat:fn,isKeyReleased:Tt,isMouseDown:vt,isMousePressed:Ze,isMouseReleased:Et,isMouseMoved:hn,loop:oi,wait:bn,play:We,volume:Or,burp:en,audioCtx:R.ctx,Timer:fe,Line:ue,Rect:Ge,Circle:at,Vec2:q,Color:v,Mat4:M,Quad:I,RNG:ke,rand:je,randi:Pt,randSeed:$n,vec2:f,rgb:T,hsl2rgb:jn,quad:Xn,choose:Kn,chance:Yn,lerp:_e,map:ut,mapc:Gn,wave:qt,deg2rad:ce,rad2deg:Wt,testLineLine:ae,testRectRect:Ft,testRectLine:ct,testRectPoint:re,drawSprite:tn,drawText:cn,formatText:me,drawRect:j,drawLine:Pe,drawLines:nn,drawTriangle:rn,drawCircle:bt,drawEllipse:sn,drawUVQuad:Te,drawPolygon:Se,drawFormattedText:pe,drawMasked:$r,drawSubtracted:Yr,pushTransform:te,popTransform:K,pushTranslate:O,pushScale:Qe,pushRotate:jr,pushRotateX:kr,pushRotateY:Gr,pushRotateZ:Ee,pushMatrix:Nr,debug:A,scene:Oi,go:Ii,addLevel:_i,getData:Bi,setData:Mn,download:Xe,downloadJSON:sr,downloadText:Nt,downloadBlob:kt,plug:Wn,ASCII_CHARS:wr,CP437_CHARS:Ls,canvas:u.canvas,addKaboom:zi,LEFT:q.LEFT,RIGHT:q.RIGHT,UP:q.UP,DOWN:q.DOWN,RED:v.RED,GREEN:v.GREEN,BLUE:v.BLUE,YELLOW:v.YELLOW,MAGENTA:v.MAGENTA,CYAN:v.CYAN,WHITE:v.WHITE,BLACK:v.BLACK,quit:ns};if(i.plugins&&i.plugins.forEach(Wn),i.global!==!1)for(let e in Re)window[e]=Re[e];return Re},"default");module.exports=hs($s);
